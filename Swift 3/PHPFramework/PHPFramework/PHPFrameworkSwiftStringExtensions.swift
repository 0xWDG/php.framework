...
public extension String {
    ...
    public func ireplace(_ target: String, withString: String) -> String {
        return self.replacingOccurrences(of: target, with: withString, options: NSString.CompareOptions.caseInsensitiveSearch, range: nil)
    }
...
//		return self[leftRange.endIndex...rightRange.index(before: rightRange.startIndex)]
        return self[leftRange.upperBound...rightRange.lowerBound] //rightRange.startIndex.predecessor()]
	...
	func stripPunctuation() -> String {
		return components(separatedBy: NSCharacterSet.punctuation())
			.joined(separator: "")
