...
public let PFSCredits: String = "\(PHPFramework(false).product) " +
    "Version \(PHPFramework(false).version)" + PFSnl + PFSnl +
	"Created by:" + PFSnl +
	"Wesley de Groot (@0xWDG) http://wesleydegroot.nl" + PFSnl + PFSnl +
